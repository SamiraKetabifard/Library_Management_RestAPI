...
public interface BorrowRecordRepository extends JpaRepository<BorrowRecord, Long> {
  ...
  @Query("SELECT new com.example.library_restapi.dto.BorrowRecordDto(br.id, u.username, b.title, br.isReturned) " +
          "FROM BorrowRecord br JOIN br.user u JOIN br.book b")
  List<BorrowRecordDto> findAllBorrowRecordsAsDto();

  @Query("SELECT new com.example.library_restapi.dto.HistoryDto(b.title, br.borrowDate, br.dueDate, br.isReturned) " +
